    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        insRecButton.setOnClickListener {
            ...
            val value = ContentValues().apply {
                put(StudentRecord.LAST_NAME_COLUMN, lastName)
                put(StudentRecord.FIRST_NAME_COLUMN, firstName)
                put(StudentRecord.MIDDLE_NAME_COLUMN, middleName)
        ...
        updLastRecButton.setOnClickListener {
            ...
            // Изменить его
            val newLastName = "Иванов"
            val newFirstName = "Иван"
            val newMiddleName = "Иванович"

            val values = ContentValues().apply {
                put(StudentRecord.LAST_NAME_COLUMN, newLastName)
                put(StudentRecord.FIRST_NAME_COLUMN, newFirstName)
                put(StudentRecord.MIDDLE_NAME_COLUMN, newMiddleName)
            }
